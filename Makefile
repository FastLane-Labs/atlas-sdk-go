...
contracts-bindings:
	...
	abigen --abi ./contract/atlas/1.6-monad/abi.json --pkg atlas_1_6_monad --type Atlas --out ./contract/atlas/1.6-monad/atlas.go
	...
	abigen --abi ./contract/atlasverification/1.6-monad/abi.json --pkg atlasverification_1_6_monad --type AtlasVerification --out ./contract/atlasverification/1.6-monad/atlasverification.go
	...
	abigen --abi ./contract/simulator/1.6-monad/abi.json --pkg simulator_1_6_monad --type Simulator --out ./contract/simulator/1.6-monad/simulator.go
	...
	abigen --abi ./contract/sorter/1.6-monad/abi.json --pkg sorter_1_6_monad --type Sorter --out ./contract/sorter/1.6-monad/sorter.go
