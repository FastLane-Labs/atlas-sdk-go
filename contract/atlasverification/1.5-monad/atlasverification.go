...
package atlasverification_1_5_monad
...
// GetUserOperationHash is a free data retrieval call binding the contract method 0x4f16549b.
//
// Solidity: function getUserOperationHash((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp) view returns(bytes32 userOpHash)
...
// GetUserOperationPayload is a free data retrieval call binding the contract method 0x5f0c9724.
//
// Solidity: function getUserOperationPayload((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp) view returns(bytes32 payload)
...
// GetUserOperationsHash is a free data retrieval call binding the contract method 0x79736b6e.
//
// Solidity: function getUserOperationsHash((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 userOpHash)
func (_AtlasVerification *AtlasVerificationCaller) GetUserOperationsHash(opts *bind.CallOpts, userOps []UserOperation) ([32]byte, error) {
	var out []interface{}
	err := _AtlasVerification.contract.Call(opts, &out, "getUserOperationsHash", userOps)
...
//
// Solidity: function getUserOperationsHash((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 userOpHash)
func (_AtlasVerification *AtlasVerificationSession) GetUserOperationsHash(userOps []UserOperation) ([32]byte, error) {
	return _AtlasVerification.Contract.GetUserOperationsHash(&_AtlasVerification.CallOpts, userOps)
}

// GetUserOperationsHash is a free data retrieval call binding the contract method 0x79736b6e.
//
// Solidity: function getUserOperationsHash((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 userOpHash)
func (_AtlasVerification *AtlasVerificationCallerSession) GetUserOperationsHash(userOps []UserOperation) ([32]byte, error) {
	return _AtlasVerification.Contract.GetUserOperationsHash(&_AtlasVerification.CallOpts, userOps)
}

// GetUserOperationsPayload is a free data retrieval call binding the contract method 0x68d42e71.
//
// Solidity: function getUserOperationsPayload((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 payload)
func (_AtlasVerification *AtlasVerificationCaller) GetUserOperationsPayload(opts *bind.CallOpts, userOps []UserOperation) ([32]byte, error) {
	var out []interface{}
	err := _AtlasVerification.contract.Call(opts, &out, "getUserOperationsPayload", userOps)
...
//
// Solidity: function getUserOperationsPayload((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 payload)
func (_AtlasVerification *AtlasVerificationSession) GetUserOperationsPayload(userOps []UserOperation) ([32]byte, error) {
	return _AtlasVerification.Contract.GetUserOperationsPayload(&_AtlasVerification.CallOpts, userOps)
}

// GetUserOperationsPayload is a free data retrieval call binding the contract method 0x68d42e71.
//
// Solidity: function getUserOperationsPayload((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps) view returns(bytes32 payload)
func (_AtlasVerification *AtlasVerificationCallerSession) GetUserOperationsPayload(userOps []UserOperation) ([32]byte, error) {
	return _AtlasVerification.Contract.GetUserOperationsPayload(&_AtlasVerification.CallOpts, userOps)
}
...
// ValidateCalls is a paid mutator transaction binding the contract method 0x97b835a9.
//
// Solidity: function validateCalls((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, uint256 metacallGasLeft, uint256 msgValue, address msgSender, bool isSimulation) returns(uint256 allSolversGasLimit, uint256 allSolversCalldataGas, uint256 bidFindOverhead, uint8 verifyCallsResult)
...
// ValidateMulticalls is a paid mutator transaction binding the contract method 0x8f979d12.
//
// Solidity: function validateMulticalls((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, uint256 metacallGasLeft, uint256 msgValue, address msgSender, bool isSimulation) returns(uint256 allSolversGasLimit, uint256 allSolversCalldataGas, uint256 bidFindOverhead, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) syntheticUserOp, uint8[] verifyCallsResults)
func (_AtlasVerification *AtlasVerificationTransactor) ValidateMulticalls(opts *bind.TransactOpts, dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, metacallGasLeft *big.Int, msgValue *big.Int, msgSender common.Address, isSimulation bool) (*types.Transaction, error) {
	return _AtlasVerification.contract.Transact(opts, "validateMulticalls", dConfig, userOps, solverOps, dAppOp, metacallGasLeft, msgValue, msgSender, isSimulation)
}

// ValidateMulticalls is a paid mutator transaction binding the contract method 0x8f979d12.
//
// Solidity: function validateMulticalls((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, uint256 metacallGasLeft, uint256 msgValue, address msgSender, bool isSimulation) returns(uint256 allSolversGasLimit, uint256 allSolversCalldataGas, uint256 bidFindOverhead, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) syntheticUserOp, uint8[] verifyCallsResults)
func (_AtlasVerification *AtlasVerificationSession) ValidateMulticalls(dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, metacallGasLeft *big.Int, msgValue *big.Int, msgSender common.Address, isSimulation bool) (*types.Transaction, error) {
	return _AtlasVerification.Contract.ValidateMulticalls(&_AtlasVerification.TransactOpts, dConfig, userOps, solverOps, dAppOp, metacallGasLeft, msgValue, msgSender, isSimulation)
}

// ValidateMulticalls is a paid mutator transaction binding the contract method 0x8f979d12.
//
// Solidity: function validateMulticalls((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, uint256 metacallGasLeft, uint256 msgValue, address msgSender, bool isSimulation) returns(uint256 allSolversGasLimit, uint256 allSolversCalldataGas, uint256 bidFindOverhead, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) syntheticUserOp, uint8[] verifyCallsResults)
func (_AtlasVerification *AtlasVerificationTransactorSession) ValidateMulticalls(dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, metacallGasLeft *big.Int, msgValue *big.Int, msgSender common.Address, isSimulation bool) (*types.Transaction, error) {
	return _AtlasVerification.Contract.ValidateMulticalls(&_AtlasVerification.TransactOpts, dConfig, userOps, solverOps, dAppOp, metacallGasLeft, msgValue, msgSender, isSimulation)
}
