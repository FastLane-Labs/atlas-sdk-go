...
// Execute is a paid mutator transaction binding the contract method 0x91f5847e.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, bytes32 userOpHash, address[] executionEnvironments, address bundler, bool isSimulation) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasTransactor) Execute(opts *bind.TransactOpts, dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, userOpHash [32]byte, executionEnvironments []common.Address, bundler common.Address, isSimulation bool) (*types.Transaction, error) {
	return _Atlas.contract.Transact(opts, "execute", dConfig, userOps, solverOps, userOpHash, executionEnvironments, bundler, isSimulation)
}

// Execute is a paid mutator transaction binding the contract method 0x91f5847e.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, bytes32 userOpHash, address[] executionEnvironments, address bundler, bool isSimulation) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasSession) Execute(dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, userOpHash [32]byte, executionEnvironments []common.Address, bundler common.Address, isSimulation bool) (*types.Transaction, error) {
	return _Atlas.Contract.Execute(&_Atlas.TransactOpts, dConfig, userOps, solverOps, userOpHash, executionEnvironments, bundler, isSimulation)
}

// Execute is a paid mutator transaction binding the contract method 0x91f5847e.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, bytes32 userOpHash, address[] executionEnvironments, address bundler, bool isSimulation) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasTransactorSession) Execute(dConfig DAppConfig, userOps []UserOperation, solverOps []SolverOperation, userOpHash [32]byte, executionEnvironments []common.Address, bundler common.Address, isSimulation bool) (*types.Transaction, error) {
	return _Atlas.Contract.Execute(&_Atlas.TransactOpts, dConfig, userOps, solverOps, userOpHash, executionEnvironments, bundler, isSimulation)
}
...
// Metacall is a paid mutator transaction binding the contract method 0x51ae28b5.
//
// Solidity: function metacall((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, address gasRefundBeneficiary) payable returns(bool auctionWon)
...
// Multimetacall is a paid mutator transaction binding the contract method 0x78c2dada.
//
// Solidity: function multimetacall((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, address gasRefundBeneficiary) payable returns(bool auctionWon)
func (_Atlas *AtlasTransactor) Multimetacall(opts *bind.TransactOpts, userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, gasRefundBeneficiary common.Address) (*types.Transaction, error) {
	return _Atlas.contract.Transact(opts, "multimetacall", userOps, solverOps, dAppOp, gasRefundBeneficiary)
}

// Multimetacall is a paid mutator transaction binding the contract method 0x78c2dada.
//
// Solidity: function multimetacall((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, address gasRefundBeneficiary) payable returns(bool auctionWon)
func (_Atlas *AtlasSession) Multimetacall(userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, gasRefundBeneficiary common.Address) (*types.Transaction, error) {
	return _Atlas.Contract.Multimetacall(&_Atlas.TransactOpts, userOps, solverOps, dAppOp, gasRefundBeneficiary)
}

// Multimetacall is a paid mutator transaction binding the contract method 0x78c2dada.
//
// Solidity: function multimetacall((address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes)[] userOps, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (address,address,uint256,uint256,address,address,bytes32,bytes32,bytes) dAppOp, address gasRefundBeneficiary) payable returns(bool auctionWon)
func (_Atlas *AtlasTransactorSession) Multimetacall(userOps []UserOperation, solverOps []SolverOperation, dAppOp DAppOperation, gasRefundBeneficiary common.Address) (*types.Transaction, error) {
	return _Atlas.Contract.Multimetacall(&_Atlas.TransactOpts, userOps, solverOps, dAppOp, gasRefundBeneficiary)
}
