...
// StackVars is an auto generated low-level Go binding around an user-defined struct.
...
// Execute is a paid mutator transaction binding the contract method 0xe77cca09.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (bytes32,address,address,bool) vars) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasTransactor) Execute(opts *bind.TransactOpts, dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation, vars StackVars) (*types.Transaction, error) {
	return _Atlas.contract.Transact(opts, "execute", dConfig, userOp, solverOps, vars)
}

// Execute is a paid mutator transaction binding the contract method 0xe77cca09.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (bytes32,address,address,bool) vars) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasSession) Execute(dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation, vars StackVars) (*types.Transaction, error) {
	return _Atlas.Contract.Execute(&_Atlas.TransactOpts, dConfig, userOp, solverOps, vars)
}

// Execute is a paid mutator transaction binding the contract method 0xe77cca09.
//
// Solidity: function execute((address,uint32,address,uint32,uint32) dConfig, (address,address,uint256,uint256,uint256,uint256,uint256,address,address,uint32,uint32,address,bytes,bytes) userOp, (address,address,uint256,uint256,uint256,uint256,address,address,bytes32,address,uint256,bytes,bytes)[] solverOps, (bytes32,address,address,bool) vars) payable returns((bytes32,address,uint24,uint8,uint8,uint8,uint8,bool,bool,bool,address,uint32) ctx)
func (_Atlas *AtlasTransactorSession) Execute(dConfig DAppConfig, userOp UserOperation, solverOps []SolverOperation, vars StackVars) (*types.Transaction, error) {
	return _Atlas.Contract.Execute(&_Atlas.TransactOpts, dConfig, userOp, solverOps, vars)
}
